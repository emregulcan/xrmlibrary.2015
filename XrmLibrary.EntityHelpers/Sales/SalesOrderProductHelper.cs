...
namespace XrmLibrary.EntityHelpers.Sales
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg327957(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class SalesOrderProductHelper : BaseEntityHelper
    {
        ...
        public SalesOrderProductHelper(IOrganizationService service) : base(service)
        {
            ...
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg327957(v=crm.7).aspx";
        }
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.getsalesorderproductsfromopportunityrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
