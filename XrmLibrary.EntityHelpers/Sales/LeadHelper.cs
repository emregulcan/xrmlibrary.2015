...
namespace XrmLibrary.EntityHelpers.Sales
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg328442(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class LeadHelper : BaseEntityHelper
    {
        ...
        /*
         * INFO : Bookmarks.Lead
         * Customizing Lead Qualification Process in CRM 2015 --> http://survivingcrm.com/2015/05/customizing-lead-qualification-process-in-crm-2015/
         * 
         */
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg328442(v=crm.7).aspx";
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.qualifyleadrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
