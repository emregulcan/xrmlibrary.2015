...
namespace XrmLibrary.EntityHelpers.Sales
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg328120(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class QuoteHelper : BaseEntityHelper
    {
        ...
        /// </para>
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.convertquotetosalesorderrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="id"><c>Quote</c> Id</param>
        /// <param name="retrievedColumns">
