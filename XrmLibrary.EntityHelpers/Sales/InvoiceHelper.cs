...
namespace XrmLibrary.EntityHelpers.Sales
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg327925(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class InvoiceHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg327925(v=crm.7).aspx";
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.generateinvoicefromopportunityrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.lockinvoicepricingrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="id"><c>Invoice</c> Id</param>
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.unlockinvoicepricingrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="id"><c>Invoice</c> Id</param>
