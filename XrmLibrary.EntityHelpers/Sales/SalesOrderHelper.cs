...
{
    /// <summary>
    /// A <c>SalesOrder (order)</c> is a quote that has been accepted.
    /// This class provides mostly used common methods for <c>SalesOrder</c> entity.
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg334319(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class SalesOrderHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg334319(v=crm.7).aspx";
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.generatesalesorderfromopportunityrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.locksalesorderpricingrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.unlocksalesorderpricingrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="id"><c>SalesOrder</c> Id</param>
        /// <returns>
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.fulfillsalesorderrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="id"><c>SalesOrder</c> Id</param>
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.cancelsalesorderrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="id"><c>SalesOrder</c> Id</param>
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.convertsalesordertoinvoicerequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="id"><c>Salesorder</c> Id</param>
        /// <param name="retrievedColumns">
        ...
        Entity PrepareOrderCloseEntity(Guid id, string subject, string description, DateTime? actualEnd = null)
        {
            ...
            orderClose["salesorderid"] = new EntityReference("salesorder", id);
