...
{
    /// <summary>
    /// The <c>Organization</c> is the top level of the Microsoft Dynamics CRM business hierarchy. 
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg327960(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class OrganizationHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg327960(v=crm.7).aspx";
