...
namespace XrmLibrary.EntityHelpers.Service
{
    ...
    /// </para>
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg334373(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class ContractHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg334373(v=crm.7).aspx";
        ...
        /// Copy a contract.
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.clonecontractrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="id">
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.cancelcontractrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="id"><c>Conract</c> Id</param>
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.renewcontractrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="id">
