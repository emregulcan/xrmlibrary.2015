...
namespace XrmLibrary.EntityHelpers.BusinessManagement
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg328076(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class QueueItemHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg328076(v=crm.7).aspx";
        ...
        /// <summary>
        /// Add item to queue.
        /// Please note that you can only add item that enabled for Queue, for more information see https://msdn.microsoft.com/en-us/library/gg328459(v=crm.7).aspx#BKMK_Enabling
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.addtoqueuerequest(v=crm.7).aspx
        /// </para>
        /// </summary>
