...
namespace XrmLibrary.EntityHelpers.Security
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg328425(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class PrivilegeHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg328425(v=crm.7).aspx";
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.retrieveprivilegesetrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <returns>
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.retrieveuserprivilegesrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
