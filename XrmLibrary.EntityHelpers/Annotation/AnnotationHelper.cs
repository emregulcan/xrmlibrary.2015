...
namespace XrmLibrary.EntityHelpers.Annotation
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg334398(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class AnnotationHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg334398(v=crm.7).aspx";
