...
namespace XrmLibrary.EntityHelpers.Customer
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg327903(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class ContactHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg327903(v=crm.7).aspx";
