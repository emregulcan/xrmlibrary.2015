...
namespace XrmLibrary.EntityHelpers.Marketing
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg309509(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class CampaignHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg309509(v=crm.7).aspx";
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.additemcampaignrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// Adds an item from <c>Campaign</c>.
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.removeitemcampaignrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="campaignId"><c>Campaign</c> Id</param>
        /// <param name="itemId">Item Id</param>
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.copycampaignrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="campaignId"><c>Campaign</c> Id</param>
        /// <returns>
