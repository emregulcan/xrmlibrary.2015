...
namespace XrmLibrary.EntityHelpers.Marketing
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg309252(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class ListHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg309252(v=crm.7).aspx";
        ...
        /// You can also call <see cref="Unlock(Guid)"/> method.
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.addmemberlistrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="listId">Marketing List Id</param>
        /// <param name="memberId">
