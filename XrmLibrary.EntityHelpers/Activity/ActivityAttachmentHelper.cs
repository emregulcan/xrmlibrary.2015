...
namespace XrmLibrary.EntityHelpers.Activity
{
    ...
    /// <para> 
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg309364(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class ActivityAttachmentHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg309364(v=crm.7).aspx";
