...
namespace XrmLibrary.EntityHelpers.Security
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg334231(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class RoleHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg334231(v=crm.7).aspx";
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.removeprivilegerolerequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="roleId"></param>
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.replaceprivilegesrolerequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="roleId">Role Id</param>
