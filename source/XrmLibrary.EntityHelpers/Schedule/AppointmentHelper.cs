...
namespace XrmLibrary.EntityHelpers.Schedule
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg327905(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class AppointmentHelper : BaseEntityHelper
    {
         ...
         * URL : https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.addrecurrencerequest(v=crm.7).aspx
         */
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg327905(v=crm.7).aspx";
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.validaterequest(v=crm.7).aspx
        /// </para>
        /// </summary>
