...
namespace XrmLibrary.EntityHelpers.Customer
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg328244(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class AccountHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg328244(v=crm.7).aspx";
