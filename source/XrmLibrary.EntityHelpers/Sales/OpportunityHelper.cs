...
namespace XrmLibrary.EntityHelpers.Sales
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg334362(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class OpportunityHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg334362(v=crm.7).aspx";
        ...
        /// <summary>
        /// Get <c>Total Amount</c> of Opportunity
        /// </summary>
