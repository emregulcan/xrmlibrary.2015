...
namespace XrmLibrary.EntityHelpers.Service
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg328309(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class ContractDetailHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg328309(v=crm.7).aspx";
