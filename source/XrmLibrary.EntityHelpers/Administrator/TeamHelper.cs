...
namespace XrmLibrary.EntityHelpers.Administrator
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg309360(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class TeamHelper : BaseEntityHelper
    {
        ...
        /*
         * INFO : Bookmarks.Team
         * Use access teams and owner teams to collaborate and share information --> https://msdn.microsoft.com/en-us/library/dn481569(v=crm.7).aspx
         */
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg309360(v=crm.7).aspx";
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.removemembersteamrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="teamId"><c>Team</c> Id</param>
        /// <param name="systemuserId"><c>System User</c> Id</param>
        ...
        /// </para>
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.convertownerteamtoaccessteamrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="teamId"><c>Team</c> Id</param>
        /// <returns>
