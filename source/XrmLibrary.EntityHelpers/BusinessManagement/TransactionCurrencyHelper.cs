...
namespace XrmLibrary.EntityHelpers.BusinessManagement
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg328355(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class TransactionCurrencyHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg328355(v=crm.7).aspx";
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.retrieveexchangeraterequest(v=crm.7).aspx
        /// </para>
        /// </summary>
