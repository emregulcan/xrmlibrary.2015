...
{
    /// <summary>
    /// <c>Queue</c>s are instrumental in organizing, prioritizing, and monitoring the progress of your work while you are using Microsoft Dynamics CRM.
    /// This class provides mostly used common methods for <c>Queue</c> entity
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg328459(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class QueueHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg328459(v=crm.7).aspx";
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.addprincipaltoqueuerequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.retrieveuserqueuesrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
