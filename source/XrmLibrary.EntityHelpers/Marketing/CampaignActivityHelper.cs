...
namespace XrmLibrary.EntityHelpers.Marketing
{
    ...
    /// <para>
    /// For more information look at https://msdn.microsoft.com/en-us/library/gg328351(v=crm.7).aspx
    /// </para>
    /// </summary>
    public class CampaignActivityHelper : BaseEntityHelper
    {
        ...
        {
            this.SdkHelpUrl = "https://msdn.microsoft.com/en-us/library/gg328351(v=crm.7).aspx";
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.additemcampaignactivityrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.removeitemcampaignactivityrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="campaignActivityId"><c>CampaignActivity</c> Id</param>
        /// <param name="itemId">Item Id</param>
        ...
        /// <c>Caller</c> : All created activities are assigned to the caller of <see cref="Microsoft.Xrm.Sdk.IOrganizationService"/>
        ...
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.propagationownershipoptions(v=crm.7).aspx
        /// </para>
        /// </param>
        ...
        /// <summary>
        /// Distributes <c>CampaignActivity</c>.
        /// Creates the appropriate activity for each member in the list for the specified campaign activity.
        /// <para>
        /// For more information look at https://msdn.microsoft.com/en-us/library/microsoft.crm.sdk.messages.distributecampaignactivityrequest(v=crm.7).aspx
        /// </para>
        /// </summary>
        /// <param name="id"><c>CampaignActvity</c> Id</param>
